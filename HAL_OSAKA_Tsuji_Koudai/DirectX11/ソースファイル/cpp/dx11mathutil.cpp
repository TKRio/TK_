...
３次元ベクトルの四則演算
--------------------------*/
XMFLOAT3 XMFLOAT3Arithmetic(const XMFLOAT3& a, const XMFLOAT3& b,int count) {
	XMFLOAT3 ret = XMFLOAT3(0.0f,0.0f,0.0f);
...
//XMFLOAT3の比較
bool XMFLOAT3Comparison(const XMFLOAT3& a, const XMFLOAT3& b, int count) {
	switch (count)
	{
	case 0:
...
//!	@retval	true フラスタム内　false フラスタム外
//==============================================================================
bool IsInFrustum(const XMFLOAT3& pos, const XMFLOAT4X4& matrix, float ans[], PLAVERTEX* plane) {
...
//!	@param　ビュー変換行列＊プロジェクション変換行列
//==============================================================================
void GetPlanefromProjectionmatrix(PLAVERTEX* p, const XMFLOAT4X4& matrix) {
	// left
...
//!	@param　ビュー変換行列＊プロジェクション変換行列
//==============================================================================
void GetPlanefromProjectionmatrixWithNormalize(PLAVERTEX* p, const XMFLOAT4X4& matrix) {
